    ...
    for (const [path, scanResults] of Object.entries(scans)) {
        ...
        for (const scanResult of scanResults) {
            try {
                ...
                results.push({
                    issues: response === null || response === void 0 ? void 0 : response.issues,
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.IacDirectoryWithoutAnyIacFileError = exports.UnsupportedOptionFileIacError = exports.SupportLocalFileOnlyIacError = void 0;
...
function IacDirectoryWithoutAnyIacFileError() {
    return 'iac test support single valid file or a directory of valid files';
}
exports.IacDirectoryWithoutAnyIacFileError = IacDirectoryWithoutAnyIacFileError;
...
const unsupported_options_iac_error_1 = __webpack_require__(30555);
const invalid_iac_file_1 = __webpack_require__(88128);
const Queue = __webpack_require__(44936);
...
function extractResolutionMetaFromScanResult({ name, target, identity, }) {
    return {
        name,
        target,
        identity,
...
function assembleIacLocalPayload(fileDetails, options) {
    ...
    const payload = {
        method: 'POST',
        url: config_1.default.API + (options.vulnEndpoint || '/test-iac'),
        json: true,
        headers: {
            'x-is-ci': is_ci_1.isCI(),
...
const options_validator_1 = __webpack_require__(1570);
const policy_1 = __webpack_require__(32615);
const run_iac_test_1 = __webpack_require__(32122);
const alerts = __webpack_require__(21696);
const error_format_1 = __webpack_require__(59369);
const api_token_1 = __webpack_require__(95181);
const ecosystems_1 = __webpack_require__(5168);
